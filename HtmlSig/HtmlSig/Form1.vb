...
Public Class Form1
    ...
    Private Sub Generate_Click(sender As Object, e As EventArgs) Handles Generate.Click
        ...
        For Each current As String In File.ReadLines("htmlDoc.txt")
            ...
            End If
            If current.Contains("SALUTATION") Then
                current = ""
                If info.Item("salutation") <> "" Then
                    addSal()
                End If
            End If
    ...
    Sub addSal()
        ...
        element = <tr>
                      <td>
                          <font style="font-size: 16pt"><%= info.Item("salutation") %></font>
                      </td>
                  </tr>
        My.Computer.FileSystem.WriteAllText("C:\Users\" & user &
    ...
    Sub addAddress()
        ...
        For Each val As KeyValuePair(Of String, String) In addresses
            flag1 = True
            If val.Value.Contains("Ste.") And val.Value.Count > 4 Then
                flag = True
            Else
                flag1 = False
            End If
            If val.Value <> "" And flag1 = True Then
                flag = True
            End If
        Next
            ...
            For Each val As KeyValuePair(Of String, String) In addresses
                If val.Value <> "" Then
                    ...
                    If val.Key = "state" Or val.Key = "zip" Then
                        element = <font style="color: rgb(88,88,90); font-size: 10pt; font-family: Arial"><%= val.Value %></font>
                    Else
                        element = <font style="color: rgb(88,88,90); font-size: 10pt; font-family: Arial"><%= val.Value %>, </font>
                    End If
                    My.Computer.FileSystem.WriteAllText("C:\Users\" & user &
    ...
    Sub addSecure()
        Dim element As XElement
        element = <tr>
                      <td style="max-width: 500px;" colspan="2"><a href=<%= secure.Text %>><img style="width: 100%;" src="https://images.pfnrates.com/email_disclaimer.jpg"></img></a></td>
                  </tr>
        My.Computer.FileSystem.WriteAllText("C:\Users\" & user &
                                            "\AppData\Roaming\Microsoft\Signatures\" & fileName & ".htm", element.ToString, True)
    End Sub
    ...
    Sub addEmail()
        ...
        If info.Item("email") <> "" And web.Text <> "" Then
            ...
            If info.Item("email").Length + web.Text.Length > 43 Then
                secondary = True
                element = <tr>
                              <td style="font-family: Arial; font-size: 10pt;"><font style="color: #333333; font-size: 10pt; font-family: Arial">E: <a href="mailto:" style="color: #06c"><%= info.Item("email") %></a></font></td>
                          </tr>
                element2 = <tr>
                               <td style="font-family: Arial; font-size: 10pt;"><font style="color: #333333; font-size: 10pt; font-family: Arial">W: <a href=<%= web.Text %> style="color: #06c"><%= web.Text %></a></font></td>
                           </tr>
            Else
                element = <tr>
                              <td style="font-family: Arial; font-size: 10pt;"><font style="color: #333333; font-size: 10pt; font-family: Arial">E: <a href="mailto:" style="color: #06c"><%= info.Item("email") %></a></font><font style="color: #333333; font-size: 10pt; font-family: Arial"> | </font><font style="color: #333333; font-size: 10pt; font-family: Arial">W: <a href=<%= web.Text %> style="color: #06c"><%= web.Text %></a></font></td>
                          </tr>
            End If
        End If
        If info.Item("email") <> "" And web.Text = "" Then
    ...
    Sub addNMLS()
        ...
        If info.Item("nmls") <> "" And info.Item("dre") <> "" Then
            element = <tr>
                          <td>
                              <font style="color: rgb(88,88,90); font-size: 10pt; font-family: Arial">NMLS: <%= info.Item("nmls") %> | </font><font style="color: rgb(136, 136, 136); font-size: 10pt; font-family: Arial"><%= licType.Text %>: <%= info.Item("dre") %></font>
                          </td>
                      </tr>
        End If
        If info.Item("nmls") <> "" And info.Item("dre") = "" Then
            element = <tr>
                          <td>
                              <font style="color: rgb(88,88,90); font-size: 10pt; font-family: Arial">NMLS: <%= info.Item("nmls") %></font>
                          </td>
                      </tr>
        End If
        If info.Item("nmls") = "" And info.Item("dre") <> "" Then
            element = <tr>
                          <td>
                              <font style="color: rgb(88,88,90); font-size: 10pt; font-family: Arial"><%= licType.Text %>: <%= info.Item("dre") %></font>
                          </td>
                      </tr>
        End If
    ...
    Sub closeRow()
        My.Computer.FileSystem.WriteAllText("C:\Users\" & user &
                                                "\AppData\Roaming\Microsoft\Signatures\" & fileName & ".htm", "<tr><td style="" font-family:Arial; font-size: 10pt;"">", True)
    End Sub
                ...
                If pair.Key.Contains("phone") And pair.Value <> "" Then
                    ...
                    If max = 4 Then
                        If counter = 1 Or counter = 3 Then
                            element = <font style="color: black; font-size: 10pt; font-family: Arial"><%= pair.Key.Substring(0, 1).ToUpper %>: <a href=<%= temp %> style="color: #06c"><%= pair.Value %></a></font>
                        Else
                            element = <font style="color: black; font-size: 10pt; font-family: Arial"><%= pair.Key.Substring(0, 1).ToUpper %>: <a href=<%= temp %> style="color: #06c"><%= pair.Value %></a> | </font>
                        End If
                        My.Computer.FileSystem.WriteAllText("C:\Users\" & user &
    ...
    Sub addTitle()
        ...
        Dim element As XElement = <tr>
                                      <td style="padding-bottom: 5px; font-weight: bold; font-family: Arial; font-size: 10pt; color: rgb(51, 51, 51);">
                                          <font style="font-family: Arial; font-size: 10pt; color: rgb(51, 51, 51);"><%= current %></font>
                                      </td>
                                  </tr>
        My.Computer.FileSystem.WriteAllText("C:\Users\" & user &
                                            "\AppData\Roaming\Microsoft\Signatures\" & fileName & ".htm", element.ToString, True)
